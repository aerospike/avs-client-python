...
class About(object):
    ...
    def Get(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/aerospike.vector.About/Get',
...
class ClusterInfo(object):
    ...
    def GetNodeId(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/aerospike.vector.ClusterInfo/GetNodeId',
    ...
    def GetClusterId(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/aerospike.vector.ClusterInfo/GetClusterId',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
