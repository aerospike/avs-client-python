...
class Client(BaseClient):
    ...
    def insert(
        ...
        *,
        ...
        try:
            transact_stub.Put(insert_request, **kwargs)
    ...
    def update(
        ...
        *,
        ...
        try:
            transact_stub.Put(update_request, **kwargs)
        except grpc.RpcError as e:
            logger.error("Failed with error: %s", e)
            raise types.AVSServerError(rpc_error=e)
    ...
    def upsert(
        ...
        *,
        ...
        try:
            transact_stub.Put(upsert_request, **kwargs)
        except grpc.RpcError as e:
            logger.error("Failed with error: %s", e)
            raise types.AVSServerError(rpc_error=e)
    ...
    def get(
        ...
        *,
        ...
        try:
            response = transact_stub.Get(get_request, **kwargs)
        except grpc.RpcError as e:
            logger.error("Failed with error: %s", e)
            raise types.AVSServerError(rpc_error=e)
    ...
    def exists(
        ...
        *,
        ...
        try:
            response = transact_stub.Exists(exists_request, **kwargs)
        except grpc.RpcError as e:
            logger.error("Failed with error: %s", e)
            raise types.AVSServerError(rpc_error=e)
    ...
    def delete(
        ...
        *,
        ...
        try:
            transact_stub.Delete(delete_request, **kwargs)
        except grpc.RpcError as e:
            logger.error("Failed with error: %s", e)
            raise types.AVSServerError(rpc_error=e)
