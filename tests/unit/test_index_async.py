...
async def test_index_vector_search():
...
async def test_index_vector_search_no_params():
    mock_client = MagicMock(spec=Client)
    index = Index(
        client=mock_client,
        name="test_index",
...
async def test_index_vector_search_by_key():
    mock_client = MagicMock(spec=Client)
    index = Index(
        client=mock_client,
        name="test_index",
    ...
    await index.vector_search_by_key(
        key=key,
...
async def test_index_vector_search_by_key_no_params():
    mock_client = MagicMock(spec=Client)
    index = Index(
        client=mock_client,
        name="test_index",
...
async def test_index_is_indexed():
    mock_client = MagicMock(spec=Client)
    index = Index(
        client=mock_client,
        name="test_index",
...
async def test_index_is_indexed_no_params():
    mock_client = MagicMock(spec=Client)
    index = Index(
        client=mock_client,
        name="test_index",
...
async def test_index_get_percent_unmerged():
    mock_client = MagicMock(spec=Client)
    index = Index(
        client=mock_client,
        name="test_index",
    ...
    await index.get_percent_unmerged(
        timeout=1000,
    )
...
async def test_index_get_percent_unmerged_no_params():
    mock_client = MagicMock(spec=Client)
    index = Index(
        client=mock_client,
        name="test_index",
...
async def test_index_get_no_params():
    mock_client = MagicMock(spec=Client)
    index = Index(
        client=mock_client,
        name="test_index",
...
async def test_index_status_no_params():
    mock_client = MagicMock(spec=Client)
    index = Index(
        client=mock_client,
        name="test_index",
