...
async def test_index_create_index_storage(session_admin_client, test_case):
    await session_admin_client.index_create(
        namespace=test_case.namespace,
        name=test_case.name,
        vector_field=test_case.vector_field,
...
async def test_index_create_timeout(session_admin_client, test_case):
