...
async def test_vector_insert_without_existing_record(session_vector_client, test_case):
...
async def test_vector_insert_with_existing_record(session_vector_client, test_case):
    await session_vector_client.insert(
        namespace=test_case.namespace,
        key=test_case.key,
        record_data=test_case.record_data,
