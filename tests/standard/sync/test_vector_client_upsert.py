...
def test_vector_upsert_without_existing_record(session_vector_client, test_case, random_key):
...
def test_vector_upsert_with_existing_record(session_vector_client, test_case, random_key):
    session_vector_client.upsert(
        namespace=test_case.namespace,
        key=random_key,
        record_data=test_case.record_data,
...
def test_vector_upsert_timeout(session_vector_client, test_case, random_key, local_latency):
    if local_latency:
