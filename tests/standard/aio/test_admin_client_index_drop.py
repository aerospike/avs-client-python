...
async def test_index_drop_timeout(session_admin_client, empty_test_case, random_name):
    await session_admin_client.index_create(
        namespace="test",
        name=random_name,
        vector_field="art",
    ...
    with pytest.raises(AVSServerError) as e_info:
        for i in range(10):
            ...
            await session_admin_client.index_drop(namespace="test", name=random_name, timeout=0)
