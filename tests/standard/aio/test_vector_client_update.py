...
async def test_vector_update_with_existing_record(session_vector_client, test_case, random_key):
    try:
...
async def test_vector_update_without_existing_record(session_vector_client, test_case, random_key):
    await session_vector_client.delete(
        namespace=test_case.namespace,
        key=random_key,
    )
...
async def test_vector_update_timeout(session_vector_client, test_case, random_key, local_latency):
    if local_latency:
